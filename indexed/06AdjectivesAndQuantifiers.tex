...
The numbers between 20, 40, and 60 etc. are formed by \isi{coordination}, whereby a~coordinating element (compare with \sectref{subsec:13-2-1}) is attached to 20 and then followed by one of the numerals 1--19, as exemplified in (\ref{ex:6-10}) and (\ref{ex:6-11}). Phonologically, the complex is one word with one main \isi{accent}. Note that the order is the reverse in some other languages in the region (compare with Kohistani \iliGawri, described by \citealt[57]{baart1999a}).
