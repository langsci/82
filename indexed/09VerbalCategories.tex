...
The Past Im\isi{perfective} is formed by means of the person"=inflected im\isi{perfective} verb stem (i.e., the future verb form) followed by the invariable marker \textit{de}. It has two main functions, as a~past habitual, see (\ref{ex:9-20}), and a~past progressive, see (\ref{ex:9-21}).
