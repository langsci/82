...
\spitzmarke{Possessives.} There are two types of possessive constructions, both of which are similar in structure to the \isi{existential} expressions, where the possessor is expressed either as a~\isi{genitive} NP or postpositionally (with `from'). There is an~ap\isi{proximate} but not absolute correspondence between the first construction, in (\ref{ex:12-30})--(\ref{ex:12-32}), and inalienable possession and the second construction, in (\ref{ex:12-33})--(\ref{ex:12-34}), and alienable possession.
...
Like most IA languages, there is a~strict distinction between in\isi{transitive} and \isi{transitive} verbs in Palula. Almost without exception, a~verb stem is either in\isi{transitive} or \isi{transitive} and cannot be ambivalent or polyvalent as far as transitivity is concerned. There is, on the other hand, fairly productive \isi{valency}"=changing morphology (as described in \sectref{sec:8-5}) by which a~stem can increase or decrease its \isi{valency}. A verb's transitivity is primarily diagnosed on the basis of two factors: 1) the absence/presence of \isi{ergative} morphology in the \isi{perfective} and 2) the aspectual shift between \isi{accusative} \isi{alignment} and \isi{ergative alignment} as far as \isi{verb agreement} is concerned (see \sectref{sec:11-1}). 
...
\begin{table}[h]
\caption{Examples of simple in\isi{transitive} verbs taking a patient"=of"=change subject}
...
\begin{table}
\caption{Examples of simple in\isi{transitive} verbs taking an agent"=\isi{subject} or a patient"=of"=state subject}
...
\begin{table}
\caption{Examples of simple \isi{transitive} verbs taking an experiencer"=subject}
\begin{tabularx}{\textwidth}{ l@{\hspace{25pt}} l@{\hspace{25pt}} l@{\hspace{25pt}}
    l@{\hspace{25pt}} }
\lsptoprule
\textit{paš-} &
...
Many verbs of this type (\tabref{tab:12-trmot}) code events of movement (concrete as well as abstract) caused by a~human agent, some of them inclusive of a~vertical specification (as some of the in\isi{transitive} verbs with an~\isi{indirect object}).


\begin{table}
\caption{Examples of \isi{transitive} motion verbs with an indirect locational object}
\begin{tabularx}{\textwidth}{ l@{\hspace{25pt}} l@{\hspace{25pt}} l@{\hspace{25pt} }
    l@{\hspace{25pt}} }
\lsptoprule
\textit{čhooré} &
...
\begin{table}
\caption{Other \isi{transitive} verbs with an indirect object}
\begin{tabularx}{\textwidth}{ l@{\hspace{25pt}} l@{\hspace{25pt}} l@{\hspace{25pt}}
    l@{\hspace{25pt}} }
\lsptoprule
\textit{pašawá-} &
...
\spitzmarke{Dummy"=\isi{subject} or subjectless verbs.} Although Palula generally seems to avoid subjectless clauses, there are a~few instances, particularly in weather expressions (\tabref{tab:12-opt}), when that is possible.
...
\begin{table}
\caption{Examples of verbs with a non"=\isi{nominative} experiencer}
...
\spitzmarke{In\isi{transitive} verbs with a~postpositional object.} What can be viewed as a~metaphoric extension of the pattern of in\isi{transitive} verbs with an~\isi{indirect object} (see \sectref{subsec:12-2-4}) is the pattern of in\isi{transitive} verbs with a~dative or patient \isi{indirect object} (\tabref{tab:12-ipost}). Such indirect objects are coded with \isi{oblique} case and a~\isi{postposition} although they in a~semantic sense can be said to be primary objects.
...
\begin{table}
\caption{Examples of \isi{PCU} verbs}
\begin{tabularx}{\textwidth}{ l@{\hspace{25pt}} l@{\hspace{25pt}} l@{\hspace{25pt}}
    l@{\hspace{25pt}} }
\lsptoprule
\textit{buǰ-} &
