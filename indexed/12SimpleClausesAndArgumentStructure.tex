...
Another (normally \isi{intransitive}) verb \textit{ɡir-} `turn' may rarely be used in a~similar way, carrying the ap\isi{proximate} meaning `X turns into Y'.
...
The (normally) \isi{intransitive} verb \textit{yhe-} `come' could in some sentences be analysed as having a~function similar to \textit{háans-} with the ap\isi{proximate} meaning `X comes into existence', such as in (\ref{ex:12-29}).
...
\subsection{Simple \isi{intransitive} verbs}
\label{subsec:12-2-2}
...
\begin{table}[h]
\caption{Examples of simple \isi{intransitive} verbs taking a patient"=of"=change subject}
...
\begin{table}
\caption{Examples of simple \isi{intransitive} verbs taking an agent"=\isi{subject} or a patient"=of"=state subject}
