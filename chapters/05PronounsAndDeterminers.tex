...
\authcomm{Overlong glossing line in ex above}
\ex
\label{ex:5-2}
%modified
...
The particle \textit{eé} can also be used with  a demonstrative, as in (\ref{ex:5-11}). 
...
\authcomm{Slightly overlong first line in ex}
\begin{exe}
\ex
\label{ex:5-12}
...
\authcomm{Overlong first glossing line in ex below}
\begin{exe}
\ex
\label{ex:5-35}
%modified
...
\authcomm{Slightly overlong lines in ex below}
\begin{exe}
\ex
\label{ex:5-53}
%modified
