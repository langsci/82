...
in the nominal (\tabref{tab:3-16}), 
adjectival (\tabref{tab:3-19}), \todo{check ordering of refs}
and verbal paradigms (\tabref{tab:3-17}) of anticipatory fronting (``umlaut'') of \textit{aa} to \textit{ee} when preceding an~\textit{i} in the following syllable. The anticipation normally does not occur if the \textit{a} is short. 
