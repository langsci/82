...
The numbers between 20, 40, and 60 etc. are formed by coordination, whereby a~coordinating element (cf. \sectref{subsec:13-2-1}) is attached to 20 and then followed by one of the numerals 1--19, as exemplified in (\ref{ex:6-10}) and (\ref{ex:6-11}). Phonologically, the complex is one word with one main accent. Note that the order is the reverse in some other languages in the region (cf. Kohistani Gawri, \citealt[57]{baart1999a}).
...
Emphasis or exclusiveness can be added to a~numeral with a~particle \textit{eé} (cf. emphasised pronouns, \sectref{sec:5-1}), as in (\ref{ex:6-13}), giving the meaning `only ten, etc.'
...
Another group of Palula quantifiers is made up of non"=numerally quantifying or somewhat existential expressions. Some of them are distributionally rather flexible:
