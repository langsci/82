...
\ex
\label{ex:10-6}
\gll [bíiḍ-u mhoór-u] [bíiḍ-u šišáw-u šay] bh-áan-u\\
...
\ex
\label{ex:10-10}
\gll [phaíi báabu] ǰhaamatreé díi xarčá bi dawa-áan-u \\
...
\ex
\label{ex:10-13}
\gll [qaribán bhiíš kaal-á] maxadúši  \\
...
\ex
\label{ex:10-18}
\gll [eení ɡhooṣṭ-á] šíiṭi ma seé hín-u\\
...
\ex
\label{ex:10-22}
\gll [ɣeirat"=xaán hakim-í] ɡhooṣṭ-á panaahí dawéel-i \\
...
\ex
\label{ex:10-24}
\gll bhiooṛkúi$\sim$ ba [pir=saahíb] ǰáand-u de \\
...
\ex
\label{ex:10-39}
\gll [díiš-ii yaá teeṇíi qóom-ii] áa ɡhaḍeeró  \\
...
\ex
\label{ex:10-51}
\gll eesé dáwur"=ii eeṛé keéṇ [ɡéeḍ-i keéṇ] de \\
...
\ex
\label{ex:10-54}
\gll [puróoṇ-a xálak] asíi díiš-a wée hín-a \\
...
However, as was pointed out in Chapter \sectref{chap:6}, there is a~category of invariable (non"=inflecting) adjectives, not showing any kind of overt agreement at all with the head of the noun phrase, such as \textit{muxtalíf} in (\ref{ex:10-56}) and \textit{taaqatwár} in (\ref{ex:10-57}). It should be noted that although such adjectives do occur attributively, they are more readily used predicatively and some of them exclusively so.

\begin{exe}
\ex
\label{ex:10-56}
\gll aalmaaríi bi [muxtalíf ḍizeen-í] yhéend-i \\
...
\ex
\label{ex:10-67}
\gll [tasíi yéei] /{\ldots}/ [bíiḍ-i xafá] bhíl-i hín-i\\
