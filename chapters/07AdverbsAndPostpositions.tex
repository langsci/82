...
\label{ex:7-4}
%modified
\gll ṣiṣ ba [aníi=wee] bi buṭ-í \textbf{aníi=wee}  bi buṭ-í \\
...
\label{ex:7-5}
%modified
\gll [huṇḍ] ta c̣hiítr=ee \textbf{bhun} ba ɡhaawaáz de  \\
...
\label{ex:7-49}
%modified
\gll na ta [tanaám the] dít-i na ba  \textbf{asaám} \textbf{the} dít-i \\
...
\label{ex:7-61}
%modified
\gll lhooméi [teeṇíi mákar-a ǰhulí] \textbf{askúun-a} \textbf{baándi} kuhée díi nikhéet-i\\
