...
The genitive is also used for the object in constructions with the verb \textit{ǰe-} `hit', (\ref{ex:4-23}). The background of this special case may possibly be explained (as \citealt[43]{baart1999a}, has done for Kalam Kohistani) with an~implicit object with the nominal meaning `hit'.
