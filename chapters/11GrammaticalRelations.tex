...
\ex
\label{ex:11-1}
\glll ak praší phará [se] b-éen de \\
...
\ex
\label{ex:11-7}
\glll [kúṛi] teeṇíi [ɡhúuṛu] deec̣hinéeti ḍáḍi nuuṭóol-u \\
...
\ex
\label{ex:11-7b}
\glll [tíi] /{\ldots}/ [tanaám] bíiḍ-a tanɡ thíil-a hín-a \\
...
\ex
\label{ex:11-8}
\glll [kaṭamúš-\textsc{ø}] /{\ldots}/ sóon-a dúši ɡúum  hín-u \\
