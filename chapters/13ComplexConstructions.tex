...
\ex
\label{ex:13-4}
\gll ɡírii dhiaáṛ [raál bh-éen-i=ee nam-éen-i]  \\
...
\ex
\label{ex:13-5}
\gll táa ɡíia ta ɡíri ǰhulí xaamaár [dhreéɡ de hín-u=ee níindra-m maǰí hín-u aaraám ki] \\
...
\ex
\label{ex:13-9}
\gll eení ɡhooṣṭ-á šíiṭi [ma seé hín-u míi kuṛi seé hín-i míi preṣ seé hín-i] \\
...
\ex
\label{ex:13-27}
\gll ɡhaḍeerá mána thíil-u [xu so áahola tool"=íi eé de] \\
...
\ex
\label{ex:13-32}
\gll díiš-e xálak-a ǰáma bhe kir kareé=ɡale bíiḍ-u dít-u síinta ba [panǰ phuṭ-í ṣo phuṭ-í] kir dít-u síinta ba\\
...
\ex
\label{ex:13-34}
\gll típa lo šay phed-í asaám [yaá=ba kh-óo yaá=ba na kh-óo] \\
...
\ex
\label{ex:13-41}
\gll méeǰi [na ta] ṣoo-íi tarap-íi ɡa faaidá=[ee] [na ba] barawulxáan-ii tarap-íi ɡa faaidá \\
...
\ex
\label{ex:13-44}
\gll \label{bkm:Ref190770484}[báaba ba yákdam bhíiru mheer-í] [tasíi púustu ɡaḍ-í] so púustu tas ṣaawóol-u  \\
...
\ex
\label{ex:13-47}
\gll eesé míiš-a ba toopaančá ɡaḍ-í [se dhuumíi(y)"=ii ǰít-i de ta] se dhuumíi uḍheewíl-i de \\
...
\ex
\label{ex:13-56}
\gll [kareé=ɡale se múṛ-im ta] asím tenaám ḍhanɡéel"=im \\
...
\ex
\label{ex:13-57}
\gll [hasó kareé=ɡale ki sastíil-u ta] ṣuú itlaá phedíl-i \\
...
\ex
\label{ex:13-59}
\gll [iẓḍúuṛ-a ǰe ɡúum"=ii pahúrta] tas yhéel-i audás \\
...
\ex
\label{ex:13-64}
\gll yhaí [tasíi háat"=ii ɡhaš-í] ḍúkur-a šíiṭi the [ɡhin-í] ɡíia hín-a  \\
...
\spitzmarke{Accompanying circumstance.} The Converb construction can also express an~accompanying circumstance, or a~means specification with reference to the same subject and the same event. In (\ref{ex:13-66})--(\ref{ex:13-68}) a~subsequential interpretation is even less of an~issue.
...
\ex
\label{ex:13-73}
\gll yhaí [se ṭék-a d-aini-eé] huṇḍ-íi utrapíl-i hín-i se míiš kh"=ainií the \\
...
\ex
\label{ex:13-81}
\gll nu ba [asaám mhaar"=ainií the] ukháat-u de\\
...
\ex
\label{ex:13-82}
\gll phoo-íi ɡhooṣṭ-íi tarap-íi tasíi axpul-aán kuṛíina míiš-a [teeṇíi se bhoóy paš-ainií the] bi-áan-a \\
...
Often, the verb itself is implicit in the purpose clause, and instead the direct object argument, `bowls' in (\ref{ex:13-83}), receives the ``dative'' marking.

\begin{exe}
\ex
\label{ex:13-83}
\gll théeba se iṇc̣ kaṭamuš-á the óol thawaá [looṛíi-am the] ɡíia hín-a \\
...
\ex
\label{ex:13-87}
\gll [panaahí dawainíi-a] ɣeiratxaan-á ba tes teeṇíi ɡhúuṛu tés=te de ba tes har-í har-í raulée phará the ba nawaab-í ḍáḍi lanɡúul-u \\
...
\ex
\label{ex:13-92}
\gll [so wáǰa ba eeṛó ki so lhookeer-ó brhóo so kaná pharé ɡal-í
...
\ex
\label{ex:13-95}
\gll [bíiḍ-u táru bi dít-u seentá] xaraáp  bh-éen-i \\
...
\ex
\label{ex:13-96}
\gll [paačhambeé uthíit-u seentá] so bi  uth-íi de maní \\
...
\ex
\label{ex:13-98}
\gll [míiš-ii putr kareé zuaán bhíl-u seentá]  tas the kúṛi dawainií
bandubás  th-áan-u \\
...
\ex
\label{ex:13-103}
\gll [inšaalaáh heenṣúka paás bhíl-a heentá]  ɡhróom-a iskuul-í the wh-áaya \\
...
\ex
\label{ex:13-104}
\gll [dúu ǰáan-a akaadúi xox bhíl-a  heentá] se bhraawú bh-áan-a,
bhraawéeli  th-áan-a \\
...
\ex
\label{ex:13-105}
\gll [thíi ninaám na phedúul-a heentá]  qeaamatée-e dees-á ma tu díi khooǰ-áam \\
...
\ex
\label{ex:13-106}
\gll [maṇḍáu kareé thíil-u heentá] maṇḍawíi ɡhareé ḍhínɡar ɡhooṣṭ-á díi tuúš muxtalíf bh-áan-u  \\
...
\ex
\label{ex:13-107}
\gll [ki anú múṛ-u heentá] ḍhanɡ-á  [anú ǰáand-u ba dharíit-u
...
\ex
\label{ex:13-108}
\gll [aṛé phoó na d-áan-a heentá] ma  pirsaahíb haṛáyuu traṭáa th-áan-u \\
...
\ex
\label{ex:13-109}
\gll [tu mheerabeení the asíi móoṇuṣ asaám d-íiṛ  heentá] šóo bh-íi  \\
...
\ex
\label{ex:13-113}
\gll [yára ma islaamabaad-á ɡáu de  heentá] šuy bhíl-u de heentá,
...
\ex
\label{ex:13-115}
\gll [áɡar tasíi dóodu ǰáand-u hín-u  heentá] tasíi úmur čuurbhišá kaal-á hóons-a \\
...
\ex
\label{ex:13-116}
\gll [tíi áɡar šúi paaṇṭí ṣéel-i de heentá  bi] so bač na bh"=eeṇḍeéu de  \\
...
\ex
\label{ex:13-124}
\gll [díiš-a ba baalbač-á kuṛíina táma  th-éen de asée bharíiw-a be
...
\ex
\label{ex:13-126}
\gll haṛó hateeṇ-ú deés de ki [ak ta kir bíiḍ-u de] dhuíime xálak-a  adrax-í heensíl-a \\
...
\ex
\label{ex:13-138}
\gll [ée míi xudaayaá ni xu ux-íi  rhaíi hín-i xéer béem ni rhaíi  ɡhaš-í ɡubáa ta] thaní\\
...
\ex
\label{ex:13-140}
\gll so hairán bhíl-u ki [aṛé čhéelí  dúu khur-áam ǰhulí keé uth-í hín-i] thaní \\
...
\ex
\label{ex:13-148}
\gll dac̣híl-u ta [so ba rištaá  xučhá-ii so máamu] \\
...
\ex
\label{ex:13-149}
\gll káakeṛ dhay-íi ta [dúu peereṇíi-a hasé ziaarat-í  pičha-aníi the yéel"=im]\\
...
\ex
\label{ex:13-157}
\gll [putr-íi ǰhaní th-ainií] zarurí bh-áan-u \\
...
\ex
\label{ex:13-159}
\gll típa [las haár d-ainií] asíi mooqá  hín-u \\
...
\ex
\label{ex:13-160}
\gll tíi [dhoóṛ yh-ainií] koošíš thíil-i \\
...
\ex
\label{ex:13-162}
\gll eesé mehfil-í wée [rhoó d-ainií] ma  aamúuṣ-um de \\
...
\ex
\label{ex:13-170}
\gll se ṭhaaṭáak-a bi [tas sanɡí kh-ainií]  široó thíil-u \\
...
\ex
\label{ex:13-173}
\gll se [har deés akaadúi paš-ainií] daw-óon de \\
...
\ex
\label{ex:13-174}
\gll eeṛé wáǰa ǰhulí alaahtaalaá [tas dubaará dunia-í  the phray"=ainií] iraadá thíil-u \\
...
\ex
\label{ex:13-175}
\gll [neečíir th-eníi-e] díiš-e xalk-íim xwaaíš thíil-i \\
...
\ex
\label{ex:13-176}
\gll [tas the kúṛi daw-ainií] bandubás th-áan-u \\
...
\ex
\label{ex:13-179}
\gll ɡhaḍeeró miṭínɡ xátum bhíl-ii pahúrta [asaám  b-ainií the] uṛ-íi=ee \\
...
\ex
\label{ex:13-182}
\gll yheí se kuṇaak-á the išaará thíil-u  ki [ma khúna yha] thaní \\
...
\ex
\label{ex:13-192}
\gll [kasée=ɡale máaṭu dhraǰaá ba šúul-a the  phedíl-u heentá] hasó kh-úu \\
...
\ex
\label{ex:13-194}
\gll [ṣiúul-a ɡubáa=ɡale maníit-u ta] lhooméi kaṇ  th-íi de \\
...
\ex
\label{ex:13-195}
\gll [koó eesé ṭeem-íi haazír na heensíl-u  heentá] tasíi mux-íi nikh"=aaṇḍeéu bh-áan-u \\
...
\ex
\label{ex:13-195b}
\gll [kanáa húuši ziaát bh-íi de] eendáa so musaafár šukhaáu teeṇíi huǰut-í pharé pail-óo de\\
...
\ex
\label{ex:13-200}
\gll [áaṛu heensíl-u heentá] eesó ḍhínɡar aaindá  dapáara nakaám bh-áan-u  \\
...
\ex
\label{ex:13-204b}
\gll áa ba [habibulaxaán thaní] míiš de [mar-í hín-u]\\
...
\ex
\label{ex:13-207}
\gll [máa=ee tu ɡa bheš-í hín-a]  eení ɡhooṣṭ-á šíiṭi\\
...
\ex
\label{ex:13-213}
\gll lawrái thaní zhaáy hín-i    [eetasíi se ɣar-í the asím tas     phedóol-u]\\
