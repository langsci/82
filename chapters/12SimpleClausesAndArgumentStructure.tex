...
%modified
%modified
\gll \textbf{míi} \textbf{nóo}\textsubscript{\textsc{sbj}} \textbf{laalzamaán}\textsubscript{\textsc{prd}} \\
...
%modified
%modified
\gll \textbf{aní}\textsubscript{\textsc{sbj}} \textbf{mheerabaán} \textbf{thaní} \textbf{ak} \textbf{kúṛi-e} \textbf{ziaarát}\textsubscript{\textsc{prd}} \textbf{aṛé}\textsubscript{\textsc{sbj}} ba \textbf{tesée} \textbf{dhi-yí} \textbf{ziaarát}\textsubscript{\textsc{prd}} \\
...
%modified
%modified
\gll muṣṭuí niiɡiraá \textbf{mal-íim"=ii} \textbf{kasubɡár}\textsubscript{\textsc{prd}} \textbf{ma}\textsubscript{\textsc{sbj}} \\
...
%modified
%modified
\gll se nóo-wa maǰí \textbf{aakatí} \textbf{nóo-wa}\textsubscript{\textsc{prd}} \textbf{aní}\textsubscript{\textsc{sbj}} \\
...
%modified
%modified
\gll \textbf{beezaadxaan-íi}\textsubscript{\textsc{prd{\ldots}}} \textbf{ma}\textsubscript{\textsc{sbj}} \textbf{putr}\textsubscript{\textsc{{\ldots}prd}} \\
...
%modified
%modified
\gll \textbf{miirǰamadaár}\textsubscript{\textsc{prd}} ba \textbf{tasíi} \textbf{nóo}\textsubscript{\textsc{sbj}} de \\
...
%modified
%modified
\gll \textbf{áa}\textsubscript{\textsc{sbj}} ba \textbf{habibulaaxaán} \textbf{thaní} \textbf{míiš}\textsubscript{\textsc{prd}} de \\
...
%modified
%modified
\gll \textbf{mhamadíin-e} \textbf{putr}\textsubscript{\textsc{sbj}} ba \textbf{xaeerudíin}\textsubscript{\textsc{prd}}, \textsc{\textbf{}xaeerudíin-e putr}\textsubscript{\textsc{sbj}} ba \textbf{ɣeyratxaán}\textsubscript{\textsc{prd}} \\
...
%modified
%modified
\gll \textbf{ma}\textsubscript{\textsc{sbj}} \textbf{míiš}\textsubscript{\textsc{prd1}} na de, bálki maǰburí ki \textbf{míiš}\textsubscript{\textsc{prd2}} bhíl-i de \\
...
\label{ex:12-11}
%modified
\gll \textbf{lhoók-u} \textbf{díiš}\textsubscript{\textsc{prd}} de \\
...
\label{ex:12-12}
%modified
\gll \textbf{c̣hiṇ} \textbf{zamaan-á}\textsubscript{\textsc{prd}} de \\
...
%modified
%modified
\gll aṛó ǰinaazá asaám díi ɡhašá, \textbf{zhaáy}\textsubscript{\textsc{sbj}} \textbf{naawás}\textsubscript{\textsc{prd}} hín-i \\
...
%modified
%modified
\gll \textbf{moosúm}\textsubscript{\textsc{sbj}} típa \textbf{šuy}\textsubscript{\textsc{prd}} hín-u \\
...
%modified
%modified
\gll \textbf{so} \textbf{báaṭ}\textsubscript{\textsc{sbj}} \textbf{ɣoṛ}\textsubscript{\textsc{prd}} de \\
...
%modified
%modified
\gll tasíi nóo kaṭamúš de, \textbf{so}\textsubscript{\textsc{sbj}} \textbf{bíiḍ-u} \textbf{trók-u}\textsubscript{\textsc{prd}} de \\
...
%modified
%modified
\gll \textbf{se}\textsubscript{\textsc{sbj}} heewand-á \textbf{bíiḍ-a} \textbf{xušaán}\textsubscript{\textsc{prd}} hóons"=an de \\
...
%modified
%modified
\gll aní čhoot-á kha ta, \textbf{tu}\textsubscript{\textsc{sbj}} \textbf{čaáx}\textsubscript{\textsc{prd}} bh-íiṛ \\
...
%modified
%modified
\gll \textbf{be}\textsubscript{\textsc{sbj}} \textbf{khilaí}\textsubscript{\textsc{prd}} ba na de \\
...
%modified
%modified
\gll \textbf{míi} \textbf{ɡhoóṣṭ}\textsubscript{\textsc{sbj}} \textbf{lookúṛi}\textsubscript{\textsc{prd}} hín-u \\
...
%modified
%modified
\gll \textbf{so} \textbf{iškaarí} \textbf{méeš}\textsubscript{\textsc{sbj}} \textbf{muṭ-á} \textbf{wée}\textsubscript{\textsc{prd}} hín-u \\
...
%modified
%modified
\gll dac̣h-íi ta \textbf{kúṛi}\textsubscript{\textsc{sbj}} ba \textbf{ɡhooṣṭ-á} \textbf{šíiṭi}\textsubscript{\textsc{prd}} na heensíl-i de \\
...
%modified
%modified
\gll \textbf{se} \textbf{baṭ-á} \textbf{ǰhulí}\textsubscript{\textsc{prd}} \textbf{se} \textbf{kuṇaak-íi} \textbf{paaṇṭí}\textsubscript{\textsc{sbj}} bi heensíl-i de, \textbf{teewiz-í}\textsubscript{\textsc{sbj}} bi heensíl-i de \\
...
\label{ex:12-24}
%modified
\gll aní dees-óom atshareet-á wée \textbf{qariibán} \textbf{čúur} \textbf{zára} \textbf{kušúni}\textsubscript{\textsc{sbj}} hín-a \\
...
\label{ex:12-25}
%modified
\gll bhuná \textbf{áa} \textbf{ɡíri}\textsubscript{\textsc{sbj}} heensíl-i \\
...
\label{ex:12-36}
%modified
\gll aakatí reet-íi baád \textbf{so}\textsubscript{\textsc{sbj}} múṛ-u \\
...
\label{ex:12-37}
%modified
\gll andáa bhíl-u ta \textbf{šíin"=ii} \textbf{čoreé} \textbf{šeenbóo-a}\textsubscript{\textsc{sbj}} phooṭíl-a\\
...
\label{ex:12-38}
%modified
\gll \textbf{ma}\textsubscript{\textsc{sbj}} roošnaám raɣáṣṭi uth-áan-u  \\
...
%modified
%modified
\gll \textbf{karáaṛu}\textsubscript{\textsc{sbj}} \textbf{asaám}\textsubscript{\textsc{do}} kh-úu \\
...
%modified
%modified
\gll \textbf{tíi}\textsubscript{\textsc{sbj}} \textbf{áa} \textbf{ḍáaɡ}\textsubscript{\textsc{do}} mheeríl-u \\
...
%modified
%modified
\gll eetíi maǰí \textbf{luumée}\textsubscript{\textsc{sbj}} \textbf{kaṭamuš-íi} \textbf{lhéṇḍ-i} \textbf{kakaríi}\textsubscript{\textsc{do}} dhríṣṭ-i hín-i \\
...
%modified
%modified
\gll \textbf{ak} \textbf{čoór}\textsubscript{\textsc{sbj}} \textbf{tesée} \textbf{ɡhooṣṭ-á}\textsubscript{\textsc{io}} ačíit-u \\
...
%modified
%modified
\gll \textbf{tusaám} \textbf{the}\textsubscript{\textsc{io}} rhootašíia \textbf{páanǰ} \textbf{toobak-í}\textsubscript{\textsc{sbj}} phéd-an  \\
...
%modified
%modified
\gll \textbf{tíi}\textsubscript{\textsc{sbj}} bi \textbf{teeṇíi} \textbf{zaán}\textsubscript{\textsc{do}} \textbf{wíi-a}\textsubscript{\textsc{io}} ɡaíl-i hín-i \\
...
%modified
%modified
\gll \textbf{ḍaaktar-á}\textsubscript{\textsc{sbj}} \textbf{bidráaɡu}\textsubscript{\textsc{do}} \textbf{xatrá} \textbf{díi}\textsubscript{\textsc{io}} ɡaḍíl-u \\
...
%modified
%modified
\gll \textbf{se} \textbf{ɣar-í} \textbf{the}\textsubscript{\textsc{io}} \textbf{asím}\textsubscript{\textsc{sbj}} \textbf{tas}\textsubscript{\textsc{do}} phedóol-u \\
...
%modified
%modified
\gll \textbf{šišíi-e} \textbf{hakim-á}\textsubscript{\textsc{sbj}} \textbf{thíi} \textbf{so} \textbf{duṣmán}\textsubscript{\textsc{do}} \textbf{nawaab-á} \textbf{ḍáḍi}\textsubscript{\textsc{io}} phreyíl-u\\
...
%modified
%modified
\gll \textbf{so}\textsubscript{\textsc{sbj}} \textbf{nis}\textsubscript{\textsc{do}} \textbf{har} \textbf{áak-a} \textbf{the}\textsubscript{\textsc{io}} man-áan-u \\
...
%modified
%modified
\gll \textbf{tusaám}\textsubscript{\textsc{io(exp)}} \textbf{níindra}\textsubscript{\textsc{sbj}} yh-éend"=im \\
...
%modified
%modified
\gll \textbf{tas} \textbf{the}\textsubscript{\textsc{ io(exp)}} \textbf{marɡ-íi} \textbf{ǰáar}\textsubscript{\textsc{sbj}} ḍhakíl-u \\
...
%modified
%modified
\gll akáaš kaal-á padúši \textbf{tas} \textbf{the} \textbf{dúu} \textbf{ziaarat-í} ḍhoowá dít-im \\
...
%modified
%modified
\gll \textbf{ma}\textsubscript{\textsc{sbj}} \textbf{tas} \textbf{sanɡí}\textsubscript{\textsc{io(primary object)}} khóṇḍ-um de ta bi so kráam th-íi de \\
...
%modified
%modified
\gll \textbf{kuṛíina}\textsubscript{\textsc{sbj}} ta \textbf{támbul"=am-ii}\textsubscript{\textsc{gen}} ǰ-íin  \\
...
%modified
%modified
\gll \textbf{aṛé} \textbf{míiš-a}\textsubscript{\textsc{sbj}} \textbf{aní} \textbf{dúu} \textbf{lhoók-a} \textbf{kučúr-am"=ii}\textsubscript{\textsc{gen}} ǰít-i \\
...
\label{ex:12-66}
%modified
\gll tanaám maǰí \textbf{áak} \textbf{míiš}\textsubscript{\textsc{sbj}} muṭ-á ǰe ukh-áai bhóo de \\
...
\label{ex:12-67}
%modified
\gll \textbf{čhéeli}\textsubscript{\textsc{sbj}} líiwee čaapeerá ɡiráa ṣéet-i \\
...
%modified
%modified
\gll \textbf{asím}\textsubscript{\textsc{sbj}} \textbf{pileeṭ-íi} \textbf{buṭheé} \textbf{mhaás}\textsubscript{\textsc{do}} kháai bhóol-u \\
...
\label{ex:12-69}
%modified
\gll \textbf{be}\textsubscript{\textsc{sbj}} mhaás kháai/khainií ṣáat-a \\
...
\ex
\label{ex:12-72}
\gll {\ob}\textbf{ɡhueeṇíi-am}{\cb}\textsubscript{\textsc{sbj}} maníit-u ki {\ob}\textbf{ni} \textbf{bíiḍ-a} \textbf{zinaawúr} \textbf{xálak-a} \textbf{hín-a}{\cb}\textsubscript{\textsc{cpl}} \\
...
\ex
\label{ex:12-73}
\gll haṛé waxtíe {\ob}\textbf{ṣiáal=ee} \textbf{lhooméi}{\cb}\textsubscript{\textsc{sbj}} bi búd-a ki {\ob}\textsc{\textbf{karáaṛu} \textbf{asaám} \textbf{kh-úu}}{\cb}\textsubscript{\textsc{cpl}} \\
...
\todo{are the small caps in \REF{ex:12-73} intended?}

\begin{exe}
\ex
\label{ex:12-74}
\gll {\ob}\textbf{ṣiúul-a}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{lhooméea} \textbf{díi}{\cb}\textsubscript{\textsc{io}} khooǰúul-u ki {\ob}\textbf{ée} \textbf{lhooméi{\ldots}}{\cb}\textsubscript{\textsc{cpl}} \\
...
\ex
\label{ex:12-75}
\gll {\ob}\textbf{dunyáii} \textbf{zinaawur-aán}{\cb}\textsubscript{\textsc{do}} {\ob}\textbf{thíi}{\cb}\textsubscript{\textsc{sbj}} aní zanɡal-í buṭheé tanɡ thíil-a hín-a \\
...
\ex
\label{ex:12-76}
\gll {\ob}\textbf{eesé}\textbf{waxt-íi} \textbf{peeɣambár} \textbf{hazrát} \textbf{iliaás} \textbf{aleehisalaam-íi} \textbf{ beetí}{\cb}\textsubscript{\textsc{do}} káaṇ na thíi de \\
...
\ex
\label{ex:12-77}
\gll {\ob}\textbf{ma}{\cb}\textsubscript{\textsc{sbj}} šíiṭi be {\ob}\textbf{tes sanɡí}{\cb}\textsubscript{\textsc{io}} {\ob}\textbf{madád}{\cb}\textsubscript{\textsc{do}} th-áam  \\
...
\ex
\label{ex:12-78}
\gll {\ob}\textbf{eetíi}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{ma} \textbf{sanɡí}{\cb}\textsubscript{\textsc{io}} {\ob}\textbf{madád}{\cb}\textsubscript{\textsc{do}} thíil-i  \\
...
\ex
\label{ex:12-79}
\gll {\ob}\textbf{so}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{ɣarib"=aan-óom} \textbf{the}{\cb}\textsubscript{\textsc{io}} bíiḍ-i {\ob}\textbf{phóom}{\cb}\textsubscript{\textsc{do}} th-íi de  \\
...
\ex
\label{ex:12-80}
\gll {\ob}\textbf{ṣuú}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{tusaám ǰhulí}{\cb}\textsubscript{\textsc{io}} {\ob}\textbf{hamlá}{\cb}\textsubscript{\textsc{do}} th-áan-u  \\
...
\ex
\label{ex:12-81}
\gll {\ob}\textbf{ak} \textbf{buzrúɡ}{\cb}\textsubscript{\textsc{sbj}} teeṇíi ɡhooṣṭ-á maṇḍayí {\ob}\textbf{nimáas}{\cb}\textsubscript{\textsc{do}} th-íi de \\
...
\ex
\label{ex:12-82}
\gll {\ob}\textbf{tíi}{\cb}\textsubscript{\textsc{sbj}} taayúu {\ob}\textbf{hiǰrát}{\cb}\textsubscript{\textsc{do}} thíil-i  \\
...
\ex
\label{ex:12-83}
\gll {\ob}\textbf{tíi}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{teeṇíi} \textbf{c̣híitr-a} \textbf{wée}{\cb}\textsubscript{\textsc{io}} {\ob}\textbf{bhootíi}{\cb}\textsubscript{\textsc{do}} thíil-i  \\
...
\ex
\label{ex:12-84}
\gll {\ob}\textbf{taním}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{teeṇíi} \textbf{c̣híitr"=am}{\cb}\textsubscript{\textsc{loc}} {\ob}\textbf{bhootíi-a}{\cb}\textsubscript{\textsc{do}} thíil"=im  \\
...
\ex
\label{ex:12-85}
\gll théeba {\ob}\textbf{ǰhaníi} \textbf{deés}{\cb}\textsubscript{\textsc{sbj}} muqarár bh-áan-u  \\
...
\ex
\label{ex:12-86}
\gll {\ob} \textbf{tasíi} \textbf{mansubá} \textbf{ǰhulí}{\cb}\textsubscript{\textsc{io}}
     {\ob}\textbf{amál}{\cb}\textsubscript{\textsc{sbj}} bhíl-i  \\
...
\ex
\label{ex:12-87}
\gll muloó díi ɣeér {\ob}\textbf{kráam}{\cb}\textsubscript{\textsc{sbj}} na bh-áan-u  \\
...
\ex
\label{ex:12-88}
\gll {\ob}\textbf{dees-á}{\cb}\textsubscript{\textsc{sbj}} teér bhíl-a \\
...
\ex
\label{ex:12-89}
\gll {\ob}\textbf{buṭheé}{\cb}\textsubscript{\textsc{sbj}} be ǰamá bhíl-a hín-a  \\
...
\ex
\label{ex:12-90}
\gll {\ob}\textbf{se} \textbf{phaí}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{se} \textbf{mac̣hook-á} \textbf{the}{\cb}\textsubscript{\textsc{io}} ašáq bhíl-i \\
...
\ex
\label{ex:12-91}
\gll óo, {\ob}\textbf{ma}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{tas} \textbf{sanɡí}{\cb}\textsubscript{\textsc{io}} milaáu bhíl-u hin-u \\
...
\ex
\label{ex:12-92}
\gll tuúš muṣṭú b-íi ta, {\ob}\textbf{áak} \textbf{luumái}{\cb}\textsubscript{\textsc{sbj}} ḍhoó dít-i hín-i \\
...
\ex
\label{ex:12-93}
\gll {\ob}\textbf{so}{\cb}\textsubscript{\textsc{sbj}} ba {\ob}\textbf{dharaṇ-í} \textbf{pharé}{\cb}\textsubscript{\textsc{io}} dhreéɡ dít-u hín-u \\
...
\ex
\label{ex:12-94}
\gll {\ob}\textbf{taním}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{šóo} \textbf{wée}{\cb}\textsubscript{\textsc{io}} {\ob}\textbf{haát}{\cb}\textsubscript{\textsc{do}} na dít-i \\
...
\ex
\label{ex:12-95}
\gll {\ob}\textbf{míi}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{áa} \textbf{ǰhandura-í} \textbf{ǰhulí}{\cb}\textsubscript{\textsc{io}} {\ob}\textbf{póo}{\cb}\textsubscript{\textsc{do}} dít-i  \\
...
\ex
\label{ex:12-96}
\gll {\ob}\textbf{alaahtaalaá}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{farišteém} \textbf{the}{\cb}\textsubscript{\textsc{io}} {\ob}\textbf{húkum}{\cb}\textsubscript{\textsc{do}} dít-u \\
...
\ex
\label{ex:12-97}
\gll {\ob}\textbf{baát}{\cb}\textsubscript{\textsc{do}} {\ob}\textbf{máa=the}{\cb}\textsubscript{\textsc{io}} da  \\
...
\ex
\label{ex:12-98}
\gll {\ob}\textbf{deeúl-ii} \textbf{xálak"=am}{\cb}\textsubscript{\textsc{sbj}} {\ob}\textbf{daawát}{\cb}\textsubscript{\textsc{do}} {\ob}\textbf{dít-i}{\cb} {\ob}\textbf{atsharíit"=am} \textbf{the}{\cb}\textsubscript{\textsc{io}} ki {\ob}\textbf{muqaabilá} \textbf{th-íia}{\cb}\textsubscript{\textsc{cpl}}  \\
...
\ex
\label{ex:12-99}
\gll haṛíiwee {\ob}\textbf{peereṇíi-a}{\cb}\textsubscript{\textsc{sbj}} har deés {\ob}\textbf{laambú}{\cb}\textsubscript{\textsc{do}} ǰ-éen de \\
...
\ex
\label{ex:12-100}
\gll {\ob}\textbf{míiš-a}{\cb}\textsubscript{\textsc{sbj}} ba {\ob}\textbf{axsí}{\cb}\textsubscript{\textsc{do}} ǰ-íin  \\
