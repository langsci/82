...
\ex
\label{ex:12-41}
\gll [karáaṛu]\textsubscript{\textsc{sbj}} [asaám]\textsubscript{\textsc{do}} kh-úu \\
...
\ex
\label{ex:12-49}
\gll [šišíi-e hakim-á]\textsubscript{\textsc{sbj}} [thíi so duṣmán]\textsubscript{\textsc{do}} [nawaab-á ḍáḍi]\textsubscript{\textsc{io}} phreyíl-u\\
