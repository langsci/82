...
\label{ex:9-1}
%modified
\gll ma nis aáǰ [kh-úum] ta rhootašíia ba kanaá \textbf{bh-úum}\\
...
\label{ex:9-2}
%modified
\gll thée míi báabu [máar-a] yaába tu [mhaar-íiṛ] yaába ṛo eé \textbf{máar-a} \\
...
\label{ex:9-3}
%modified
\gll ma aní šaak-á [háar"=um] ɡhooṣṭ-á har-í kúṛi anɡóor ǰheel-í tanaám the ɡúuli \textbf{th-íi} \\
...
\label{ex:9-20}
%modified
\gll míi so šúur máa=the bíiḍ-u šóo [ǰhóon-a de], ma ba tas the šóo [ǰhóon"=um de], máa=ee so mušqúl \textbf{bh-íia} \textbf{de} \\
...
\label{ex:9-21}
%modified
\gll so kuṇaák bhešóol-u, bhešaá tasíi paaṇṭí [ɡaḍ-íi de], paaṇṭí ɡaḍ-í čhúuṇ-i tasíi ɡaḍ-í ba táa khóol-u so kuṇaák číɣi \textbf{d-íi} \textbf{de} \\
...
\todo{please check whether source line of \REF{ex:9-29} is correct}
\ex
\label{ex:9-29}
%modified
...
\todo{please check whether source line of \REF{ex:9-35} \REF{ex:9-36} is correct}
\begin{exe}
\ex
\label{ex:9-35}
%modified
...
\label{ex:9-41}
%modified
\gll \label{bkm:Ref190742986}dhoóṛ ma yhóol-a díi muṣṭú tíi dúu xat-í \textbf{čooṇṭéel"=im} \\
...
\todo{Please check whether source line of \REF{ex:9-43} \REF{ex:9-44} is OK}
\begin{exe}
\ex
\label{ex:9-43}
%modified
\gll bíiḍ-u purúuṇ-u maasṭér, so baraaníi-e waxt-íi-e sabáq \textbf{man-í} \textbf{heensíl-u} \textbf{de} \\
...
\label{ex:9-48}
%modified
\gll man-éen-i ki ma patú [yh-óoi], ma \textbf{saat-óoi} \\
...
\todo{Please check whether source line of \REF{ex:9-54}  is OK}
\ex
\label{ex:9-54}
%modified
...
\todo{Please check whether source line of \REF{ex:9-74}  is OK}
\begin{exe}
\ex
\label{ex:9-74}
%modified
