...
camel-\textsc{obl} from ask.\textsc{pfv"=msg} \textsc{prt} \textsc{2sg.nom} human.being=\textsc{q} \\
...
\textsc{2sg.gen} head-\textsc{obl} on \textsc{prt} what be.\textsc{prs"=msg} \\
...
For questioning temporal and local adverbials, \textit{kareé} `when' and \textit{ɡóo} \textit{(B ɡúu)} `where' respectively are used, as in (\ref{ex:14-36}) and (\ref{ex:14-37}). 
...
stand.up-\textsc{cv} say.\textsc{pfv"=msg} be.\textsc{prs"=msg} \textsc{comp} oh bald.one where-\textsc{gen} from come.\textsc{pfv"=msg} \\
...
bear-\textsc{obl} say.\textsc{pfv"=msg} be.\textsc{prs"=msg} \textsc{comp} oh bald.one whither go-\textsc{prs"=msg} \\
...
\textsc{1pl.nom} trouble-\textsc{gen} time-\textsc{gen} \textsc{recp} \textsc{neg} abandon-\textsc{1pl} \textsc{quot} \\
...
other \textsc{prt} win.\textsc{pfv"=msg} \textsc{idef} robber-\textsc{pl"=obl"=gen} fort  \textsc{3sg.obl} \textsc{neg} win.\textsc{inf} be.able.to.\textsc{pfv"=msg}  \\
...
leopard \textsc{1pl.gen} word \textsc{neg} \textsc{host} do-\textsc{3sg} \textsc{1pl.acc} catch-\textsc{cv}  \textsc{prt} eat-\textsc{3sg} \\
...
káaṇ na th-íi  de \\
\textsc{prt} \textsc{rem} time-\textsc{gen} prophet lord  Elijah peace.be.upon.him-\textsc{gen} word-\textsc{pl} \textsc{host} \textsc{neg} do-\textsc{3sg} \textsc{pst} \\
...
robber-\textsc{pl"=obl"=gen} fort on thunder give.\textsc{pfv"=msg} but oh Alexander \textsc{2sg.gen} direction.\textsc{gen} \textsc{prt} \textsc{neg} \\
...
\textsc{3sg.gen} \textsc{prt} what.kind capacity \textsc{neg} stay.\textsc{pfv"=msg } \\
...
\textsc{3msg}.\textsc{gen} brother Peshawar-\textsc{obl} to go.\textsc{3sg} \textsc{pst} \textsc{prt}  \textsc{3msg.nom} \textsc{prt} \textsc{neg} go.\textsc{pfv.msg } \\
...
Uch-\textsc{obl} \textsc{3fsg.nom} go.\textsc{cv} stay.\textsc{pfv-f} be.\textsc{prs-f} Pashambi  \textsc{prt} flock take-\textsc{cv} Uch-\textsc{obl} to go.\textsc{pfv.msg} be.\textsc{prs"=msg} \\
...
\textsc{1sg.gen} house Lokuri be.\textsc{prs"=msg} school \textsc{prt} \textsc{1pl.gen} Kanegha be.\textsc{prs-f } \\
...
\textsc{2pl.nom} one.each bowl-\textsc{pl} bring-\textsc{imp.pl} bear \textsc{prt}  Katamosh-\textsc{obl} to watch become-\textsc{3sg } \\
...
\textsc{2pl.nom} ruler-\textsc{gen} all son-\textsc{pl} kill-\textsc{imp.pl-q} \textsc{3sg.acc} also  kill-\textsc{cv} woman.\textsc{pl} \textsc{prt} take-\textsc{cv} bring.up-\textsc{imp.pl-q}  house-\textsc{pl.obl} \textsc{prt} fire put.on-\textsc{imp.pl-q } \\
...
\textsc{1sg.gen} name Akhund.Seyd \textsc{1sg.gen} father.\textsc{gen} name \textsc{prt}  Gul.Seyd \textsc{1sg.gen} grandfather.\textsc{gen} name \textsc{prt} Ghulam.Seyd.Malak Ghulam.Seyd.Malak-\textsc{gen} father.\textsc{gen} name \textsc{prt} Sahib.Jee  \\
...
carpenter \textsc{refl} do.\textsc{cv} main.beam put.in-\textsc{3sg }  on.top main.beam-\textsc{obl} on \textsc{prt} cross.beam put.in-\textsc{3sg}  cross.beam-\textsc{obl} on \textsc{prt} plank-\textsc{pl} put.in-\textsc{3sg} \\
...
\textsc{3sg.gen} \textsc{idef} son be.\textsc{pst} Ghazi.Samad.Khan \textsc{prt}  \textsc{3sg.gen} name be.\textsc{pst} \\
...
\textsc{1sg.gen} line \textsc{prt} like.this-\textsc{msg } \textsc{comp} \textsc{1sg.gen} son-\textsc{gen}  name Umar.Said \\
...
see-\textsc{vn} custom \textsc{prt} \textsc{dist.nom} \textsc{comp} boy-\textsc{gen}  house-\textsc{gen} direction \textsc{3sg.gen} relative-\textsc{pl} woman.\textsc{pl}  man-\textsc{pl} \textsc{refl } \textsc{def} daughter"=in"=law see-\textsc{vn} to go-\textsc{prs"=mpl} \\
...
Islam \textsc{prt} bring.\textsc{pfv-f} be.\textsc{prs-f} Gabaroot-\textsc{gen} son-\textsc{pl.obl } \\
\glt `Islam was brought by the sons of Gabaroot.' (A:ASH054)

\ex
\label{ex:14-110}
\gll deeúli yhayí [áak bhróo ba] tíi phrayíl-u  [saaw-á the]  \\
Dir come.\textsc{cv} one brother \textsc{prt} \textsc{3sg.obl} send.\textsc{pfv"=msg}  Sau-\textsc{obl} to \\
...
\textsc{idef} woman grass in \textsc{refl} several-\textsc{f } daughter-\textsc{pl}  \textsc{3sg.gen} stay.\textsc{pfv"=fpl} \textsc{pst} \textsc{idef} single-\textsc{msg} \textsc{prt} son be.\textsc{pst} \\
...
two teacher-\textsc{pl} be.\textsc{prs"=mpl} and forty  \textsc{prt} child-\textsc{pl} be.\textsc{prs"=mpl} \textsc{1pl.gen} school  \\
...
xálaka  hín-a \\
break.\textsc{pfv"=msg} \textsc{prt} \textsc{prt} Pashtun-\textsc{pl.obl} say.\textsc{pfv"=msg}  \textsc{comp} \textsc{3pl.prox.nom} much-\textsc{mpl} wild people be.\textsc{prs"=mpl } \\
...
arrive.with.\textsc{pptc"=gen} after \textsc{prt} government informed become.\textsc{pfv"=msg}\\
