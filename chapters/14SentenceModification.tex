...
\label{ex:14-66}
%modified
\gll yéei uth-í anɡaá bhe dac̣h-íi ta kuṇaák [náin-u] darák \textbf{náin-i} índa dít-i eeṛáa dít-i \\
...
\label{ex:14-77}
%modified
\gll eetás matíl-u seentá tasíi bi ɡhiíṛ  bh-áan-u \textbf{xu} \textbf{na} \textbf{aksár]} \textbf{dhruus-áan-a}\\
...
\label{ex:14-79}
%modified
\gll uc̣hí ba se čúti-m-e zaríia baándi  so baṭ húṇṭraak c̣huɡal-áan-u  [se kúuk-a se muṭ-á bheš-aníi the] na uṛ-áan-u \textsc{\textbf{}mhaás khainíi the} na uṛ-áan-u \\
...
\label{ex:14-96}
%modified
\gll [koó ba] paiseé d-áan-a [koó ba] toobaák  d-áan-a \textbf{koó} \textbf{ba} ṭeép d-áan-a\\
...
\label{ex:14-99}
%modified
\gll tarkaáṇ teeṇíi the bheénš ɡal-íi  [rhalá bheenš-á ǰhulí ba] čauráts ɡal-íi  \textbf{čaurats-í} \textbf{ǰhulí} \textbf{ba} bhít-a ɡal-íi \\
...
\label{ex:14-107}
%modified
\gll [míi šiǰrá ba] eeteeṇ-ú ki \textbf{míi} \textbf{putr-íi} \textbf{ nóo umarseéd...}\\
...
\label{ex:14-109}
%modified
\gll [islaám ba] aṭíl-i hín-i \textbf{ɡabarúuṭ-ii} \textbf{putr-óom} \\
...
\label{ex:14-110}
%modified
\gll deeúli yhaí [áak bhróo ba] tíi phrayíl-u  \textbf{saaw-á} \textbf{the}  \\
